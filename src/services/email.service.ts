        ...
        text: `Your registration for ${ticketData.eventTitle} is confirmed. Invoice: ${ticketData.invoiceNo}. Please check the HTML version of this email for your QR code.`,        attachments: [
          {
            ...
            cid: 'qrcode', // CID reference for embedded image
          },
          {
            filename: 'stadium25-ticket-qr.png',
            content: qrBuffer,
            contentType: 'image/png',
            // No CID - downloadable attachment as backup
          },
        ],
      };
                      ...
                      <tr style="height: 426.93px;">
                        <td style="font-size: 0px; padding: 10px 25px; word-break: break-word; height: 426.93px;" align="left">
                          <div style="font-family: Inter, sans-serif; font-size: 14px; line-height: 1.5; text-align: left; color: #333333;">                            <p style="display: block; margin: 13px 0px;">Hi&nbsp;<strong>${ticketData.name.split(' ')[0]},</strong></p>
                            ...
                            <!-- QR Code Section with Multiple Display Methods -->
                            <div style="text-align: center; margin: 20px 0; padding: 15px; background-color: #f8f9fa; border-radius: 8px;">
                              ...
                              <!-- Method 1: CID embedded image (for clients that support it) -->
                              ...
                              <!-- Method 2: Fallback base64 with smaller size (if CID fails) -->
                              <div style="margin: 10px 0;">
                                <img src="${ticketData.qrDataUrl}" alt="QR Code Backup for ${ticketData.invoiceNo}" style="width: 150px; height: 150px; border: 1px solid #ccc; border-radius: 4px; display: none; margin: 0 auto;">
                              </div>
                            ...
                            <div style="text-align: center; margin: 10px 0; padding: 15px; background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px;">
                              <p style="margin: 0px 0px 10px 0px; font-size: 14px; color: #856404; font-weight: bold;">
                                Can't see the QR code above?
                              </p>
                              <p style="margin: 5px 0px; font-size: 12px; color: #856404;">
                                📧 <strong>IMPORTANT:</strong> Check your email attachments<br>
                                📎 Download: "stadium25-ticket-qr.png"<br>
                                📱 Show the downloaded image at Stadium 25 check-in
                              </p>
                              <p style="margin: 10px 0px 0px 0px; font-size: 11px; color: #856404;">
                                💡 Tip: Enable "Show Images" in your email client settings
                              </p>
                            </div>
